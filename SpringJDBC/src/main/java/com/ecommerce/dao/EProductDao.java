...
public int updateProduct(int id, String name, double price, String date){
		
		return jdbcTemplate.update("update eproduct set name = ?, price = ?, dateAdded=? where id = ? ", name, price, date, id);
	}
}
