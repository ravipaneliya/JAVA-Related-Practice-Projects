...
<body style="background-color: #82b2c0">
	...
	<form action="searchflights">
		<label for="from">FROM&nbsp;&nbsp;</label> <select name="src"
			id="from">
		...
		</select> <label>&nbsp;&nbsp;TO&nbsp;&nbsp;</label> <select name="dest" id="to">
			<option value="BOM">BOM</option>
			<option value="SRT">SRT</option>
			<option value="BAR">BAR</option>
			<option value="AMD">AMD</option>
		...
		<br> Travel Date : <input type="date" name="traveldate" required><br>
		<br> No of Traveler : <input type="number" name="travellers"
			required><br>
		<br>
	...
	<table border="1" width="500">
		...
		<tr>
			...
			<%
			String params = "fid=" + f.getId() + "&travellers=" + traveller + "&traveldate=" + traveldate + "&ec="
					+ f.getEconomy_fare() + "&pc=" + f.getPremium_fare() + "&bc=" + f.getBusiness_fare();
			%>
